...
*Paired-end pipeline:*
```
INPUTS:  read1.fq.gz            n*tech-pe.bam(b)    bio-rep-pe.bam(c)  filtered-pe.bam(d)  sized-pe.bam(e)   no_chrM-pe.bam(f)   no_chrM-pe.bam(f)  2*sized-pe.bam(e)      merged.bam(i)
         read2.fq.gz                  |                   |                    |                 |                  |            chrom.sizes        2*hs_narrowPeak.bb(g)  chrom.sizes 
         bwa_index.tgz(a)             |                   |                    |                 |                  |                  |            2*hs_signal.bw(h)           |
              |                       |                   |                    |                 |                  |                  |                    |                   |
              V                       V                   V                    V                 V                  V                  V                    V                   V
STEPS:   dnase-align-bwa-pe ==> dnase-merge-bams ==> bam-filter-pe ==> dnase-size-bam ==> dnase-eval-bam ==> sample_hotspots ==> call-hotspots ===> merge-replicates ===> call-hotspots
              |                       |                    |                   |                 |                  |                  |                    |                   |
              V                       V                    V                   V                 V                  V                  V                    V                   V
OUTPUTS: tech-pe.bam(b)         bio-rep-pe.bam(c)  filtered-pe.bam(d)    sized-pe.bam(e)  no_chrM-pe.bam(f)  hotspot_5M_qc.txt  hs_narrowPeak.bb,bed(g) merged.bam(i)        pooled_hs_narrowPeak.bb,bed
                                bio-rep-pe-qc.txt  filtered-qc.txt       sized-pe-qc.txt  sampled-pe.bam     no_chrM_5M.bam     hs_broadPeak.bb,bed     merged.bb            pooled_hs_broadPeak.bb,bed
                                                   filtered-qc-full.txt                   no_chrM-pe-qc.txt                     hotspot_signal.bw(h)    merged.bed           pooled_hotspot_signal.bw
                                                                                          sampled-pe-qc.txt                     hotspot_qc.txt          signal_corr_qc.txt   pooled_hotspot_qc.txt
                                                                                          sampled-pe-spp.txt                                            peaks_overlap_qc.txt
                                                                                          sampled-pe-pbc.txt
```
...
*Single-end pipeline:*
```
INPUTS:  read1.fq.gz            n*tech-se.bam(j)    bio-rep-se.bam(k)  filtered-se.bam(l)  sized-se.bam(m)   no_chrM-se.bam(n)   no_chrM-pe.bam(n)  2*sized-se.bam(m)      merged.bam(q)
         read2.fq.gz            or tech-pe.bam(a)         |                    |                 |                  |            chrom.sizes        2*hs_narrowPeak.bb(o)  chrom.sizes 
         bwa_index.tgz(a)             |                   |                    |                 |                  |                  |            2*hs_signal.bw(p)           |
              |                       |                   |                    |                 |                  |                  |                    |                   |
              V                       V                   V                    V                 V                  V                  V                    V                   V
STEPS:   dnase-align-bwa-se ==> dnase-merge-bams ==> bam-filter-se ==> dnase-size-bam ==> dnase-eval-bam ==> sample_hotspots ==> call-hotspots ===> merge-replicates ===> call-hotspots
              |                       |                    |                   |                 |                  |                  |                    |                   |
              V                       V                    V                   V                 V                  V                  V                    V                   V
OUTPUTS: tech-se.bam(b)         bio-rep-se.bam(k)  filtered-se.bam(l)    sized-se.bam(m)  no_chrM-se.bam(n)  hotspot_5M_qc.txt  hs_narrowPeak.bb,bed(o) merged.bam(q)        pooled_hs_narrowPeak.bb,bed
                                bio-rep-se-qc.txt  filtered-qc.txt       sized-se-qc.txt  sampled-se.bam     no_chrM_5M.bam     hs_broadPeak.bb,bed     merged.bb            pooled_hs_broadPeak.bb,bed
                                                   filtered-qc-full.txt                   no_chrM-se-qc.txt                     hotspot_signal.bw(p)    merged.bed           pooled_hotspot_signal.bw
                                                                                          sampled-se-qc.txt                     hotspot_qc.txt          signal_corr_qc.txt   pooled_hotspot_qc.txt
                                                                                          sampled-se-spp.txt                                            peaks_overlap_qc.txt
                                                                                          sampled-se-pbc.txt
```
