table narrow_idr
"IDR peaks from narrowPeak inputs. Browser extensible data BED6+14."
    (
    ...
    int     rep1_peak;       "Point-source called for replicate 1 peak"
    ...
    int     rep2_peak;       "Point-source called for replicate 2 peak"
    )
